...
import com.example.myworkoutapp.databinding.DialogBackConfBinding
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
        ...
        // START
        private var exerciseList: ArrayList<Exercise>? = null // We will initialize the list later.
        ...
        private fun customDialogForBackButton(){
            ...
            val dialogBinding=DialogBackConfBinding.inflate(layoutInflater)
        ...
        private fun setupRestView() {
            ...
            try {
                val soundURI =
                    Uri.parse("android.resource://com.example.myworkoutapp/" + R.raw.sound)
        ...
        private fun setRestProgressBar() {
            ...
            restTimer = object : CountDownTimer(10000, 1000) {
                ...
                override fun onFinish() {
                    ...
                    exerciseList!![currentExercisePosition].setSelected(true) // Current Item is selected
            ...
            exerciseTimer = object : CountDownTimer(exerciseTimerDuration * 1000, 1000) {
                ...
                override fun onFinish() {
                    ...
                    if (currentExercisePosition < exerciseList?.size!! - 1) {
                        exerciseList!![currentExercisePosition].setSelected(false) // exercise is completed so selection is set to false
                        exerciseList!![currentExercisePosition].setCompleted(true) // updating in the list that this exercise is completed
